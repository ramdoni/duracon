...
function cek_exist_schedule(ini)
{
  ...
  $.ajax({
      url: site_url+ "ajax/cekscheduletulangan", 
...
$("select#plan").on('change', function(){
  ...
  $.ajax({
      url: site_url+ "ajax/getscheduleplantulangan", 
      data: {'id' : plan_id},
      type : "POST",
      success: function(result){
        ...
        $(obj).each(function(key, val){
          ...
          html += '<td><input type="hidden" name="tulangan_id[]" class="form-control" value="'+ val.tulangan_id +'" />'+ val.product +'</td>';
...
$('.btn-add-modal').click(function(){
  ...
  html += '<td><input type="hidden" name="tulangan_id[]" class="form-control" value="'+ $("select#select-kode :selected").val() +'" />'+ $("select#select-kode :selected").html() +'</td>';
    ...
    if(id_select != ""){
      ...
      $.ajax({
          ...
          success: function(result){
            ...
            $("label.label-modal-uraian").html(obj.description);
