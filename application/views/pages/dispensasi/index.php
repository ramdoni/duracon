            ...
            <tbody>
                <?php foreach($data as $k => $item):?>
                    <tr>
                      ...
                      <td><?=status_dispensasi($item['status'])?></td>
                      <td>
                        <?php if($item['status'] == 0):?>
                        <a href="<?=site_url('dispensasi/proccess/'. $item['id'])?>" class="btn btn-success btn-xs"><i class="fa fa-arrow-right"></i> Proses Pengajuan</a>
                        <?php endif; ?>
                      </td>
                    </tr>
                <?php endforeach; ?> 
