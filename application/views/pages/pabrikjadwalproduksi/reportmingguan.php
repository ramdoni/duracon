                    ...
                    <tr class="product-plan<?=$item['id']?> <?=$bg?>">
                        ...
                        <?php foreach([1,2,3,4,5,6,7] as $hari ): ?>
                            ...
                            foreach([1, 2] as $shift):
                              $total_act  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['product_id'])['hasil_produksi'];
                  ...
                  ?>
                    <tr class="product-plan<?=$item['id']?> bggreen">
                        ...
                        <?php foreach([1,2,3,4,5,6,7] as $hari ): ?>
                            ...
                            $total_plan = 0;
                            foreach([1, 2] as $shift):
                              $total_act  += total_shift_lembar_kerja($data['id'], $hari,$shift, $item['product_id'])['hasil_produksi'];
                              $total_plan += $item['day'.$hari.'_shift'.$shift];
                            endforeach; 
