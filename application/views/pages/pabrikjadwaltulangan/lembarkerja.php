    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="demo-form2" method="post" class="form-horizontal form-label-left">
          ...
          <a href="<?=site_url("pabrikjadwaltulangan/reportmingguan/{$data['id']}")?>" class="btn btn-default btn-sm" title="Print"><i class="fa fa-bar-chart"></i> Report Mingguan</a>
                ...
                <table class="table table-bordered">
                    ...
                    <tr class="product-plan<?=$item['id']?> <?=$bg?>">
                        ...
                        <?php foreach([1,2,3,4,5,6,7] as $hari ): ?>
                            <?php foreach([1, 2] as $shift): ?>
                              <?php 
                                if($hari == 1){
                                  if($shift == 1){
                                    ...
                                    $senin_shift1_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $senin_shift1_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $senin_shift1_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];

                                  }else{
                                    $senin_shift2_plan_total += $item['day'.$hari.'_shift'. $shift]; 

                                    $senin_shift2_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $senin_shift2_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $senin_shift2_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];          
                                  }
                                }
                                ...
                                if($hari == 2){
                                  if($shift == 1){
                                    ...
                                    $selasa_shift1_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $selasa_shift1_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $selasa_shift1_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];           
                                  }else{
                                    $selasa_shift2_plan_total += $item['day'.$hari.'_shift'. $shift];    

                                    $selasa_shift2_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $selasa_shift2_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $selasa_shift2_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];         
                                  }
                                }
                                ...
                                if($hari == 3){
                                  if($shift == 1){
                                    ...
                                    $rabu_shift1_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $rabu_shift1_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $rabu_shift1_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];         
                                  }else{
                                    $rabu_shift2_plan_total += $item['day'.$hari.'_shift'. $shift];   

                                    $rabu_shift2_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $rabu_shift2_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $rabu_shift2_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];          
                                  }
                                }
                                ...
                                if($hari == 4){
                                  if($shift == 1){
                                    ...
                                    $kamis_shift1_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $kamis_shift1_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $kamis_shift1_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];           
                                  }else{
                                    $kamis_shift2_plan_total += $item['day'.$hari.'_shift'. $shift]; 

                                    $kamis_shift2_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $kamis_shift2_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $kamis_shift2_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];            
                                  }
                                }
                                ...
                                if($hari == 5){
                                  if($shift == 1){
                                    ...
                                    $jumat_shift1_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $jumat_shift1_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $jumat_shift1_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];          
                                  }else{
                                    $jumat_shift2_plan_total += $item['day'.$hari.'_shift'. $shift];  

                                    $jumat_shift2_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $jumat_shift2_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $jumat_shift2_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];           
                                  }
                                }
                                ...
                                if($hari == 6){
                                  if($shift == 1){
                                    ...
                                    $sabtu_shift1_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $sabtu_shift1_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $sabtu_shift1_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];           
                                  }else{
                                    $sabtu_shift2_plan_total += $item['day'.$hari.'_shift'. $shift];  

                                    $sabtu_shift2_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $sabtu_shift2_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $sabtu_shift2_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];           
                                  }
                                }
                                ...
                                if($hari == 7){
                                  if($shift == 1){
                                    ...
                                    $minggu_shift1_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $minggu_shift1_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $minggu_shift1_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];           
                                  }else{
                                    $minggu_shift2_plan_total += $item['day'.$hari.'_shift'. $shift];   

                                    $minggu_shift2_act        += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi'];
                                    $minggu_shift2_finishing  += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];
                                    $minggu_shift2_reject     += total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing'];          
                                  }
                                }
                              ...
                              <td class="right-text">
                                  <a href="#" class="editable-lembarkerjaitem" data-tulangan_schedule_id="<?=$data['id']?>" data-day="<?=$hari?>" data-shift="<?=$shift?>" data-type_input="hasil_produksi" data-type="text" data-tulangan_id="<?=$item['tulangan_id']?>"  data-url="<?=site_url()?>ajax/inputlembarkerja">
                                    <?=total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['hasil_produksi']?>
                                  </a>
                                </a>
                              </a>
                              </td>
                              <td class="right-text">
                                 <a href="#" class="editable-lembarkerjaitem" data-tulangan_schedule_id="<?=$data['id']?>" data-day="<?=$hari?>" data-shift="<?=$shift?>" data-type_input="finishing" data-type="text" data-tulangan_id="<?=$item['tulangan_id']?>"  data-url="<?=site_url()?>ajax/inputlembarkerja">
                                    <?=total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['finishing']?>
                                  </a>
                              </td>
                              <td class="right-text">
                                <a href="#" class="editable-lembarkerjaitem" data-tulangan_schedule_id="<?=$data['id']?>" data-day="<?=$hari?>" data-shift="<?=$shift?>" data-type_input="reject" data-type="text" data-tulangan_id="<?=$item['tulangan_id']?>"  data-url="<?=site_url()?>ajax/inputlembarkerja">
                                  <?=total_shift_lembar_kerja_tulangan($data['id'], $hari,$shift, $item['tulangan_id'])['reject']?>
                                </a>
                              </td>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
                  ...
                  <tr>
                    ...
                    <?php foreach([1,2,3,4,5,6,7] as $hari ): ?>
                          <?php foreach([1, 2] as $shift): ?>
                            <?php 
                              $pekerja_lembur = $this->db->get_where('tulangan_schedule_pekerja', ['tulangan_schedule_id' => $data['id'], 'day' => $hari, 'shift' => $shift])->row_array();
                            ...
                            <th colspan="4">
                              Total Actual Pekerja : 
                                <a href="#" class="editable-inputpekerjalembur" data-tulangan_schedule_id="<?=$data['id']?>" data-day="<?=$hari?>" data-shift="<?=$shift?>" data-type_input="pekerja" data-type="text"><?=$pekerja?></a><br />

                              Total Lembur : <a href="#" class="editable-inputpekerjalembur" data-tulangan_schedule_id="<?=$data['id']?>" data-day="<?=$hari?>" data-shift="<?=$shift?>" data-type_input="lembur" data-type="text"><?=$lembur?></a>
...
<!-- /end modal -->
<script src="<?=base_url()?>assets/js/lembarkerjatulangan.js?rand=<?=date('His')?>"></script> 
<style type="text/css">
.right-text {
  text-align: right;
}
