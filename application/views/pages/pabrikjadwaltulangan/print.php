...
<table>
	...
	<?php 
		$total_cetakan_shift1 = $this->db->query("SELECT (sum(day1_shift1) + sum(day2_shift1) + sum(day3_shift1) + sum(day4_shift1) + sum(day5_shift1) + sum(day6_shift1) + sum(day7_shift1)) as total FROM tulangan_schedule_plan where tulangan_schedule_id={$data['id']}")->row();
        $total_cetakan_shift2 = $this->db->query("SELECT (sum(day1_shift2) + sum(day2_shift2) + sum(day3_shift2) + sum(day4_shift2) + sum(day5_shift2) + sum(day6_shift2) + sum(day7_shift2)) as total FROM tulangan_schedule_plan where tulangan_schedule_id={$data['id']}")->row();
