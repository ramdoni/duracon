          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select class="form-control select_sistem_pembayaran" required="true" name="Customer[sistem_pembayaran]">
                  ...
                  $sistem_pembayaran  = ['Cash' => 'Cash', 'Kredit' => 'Kredit','Kredit denga DP' => 'Kredit denga DP', 'SCF' => 'SCF (Supply Chain Finance)', 'SKBDN' => 'SKBDN (Surat Kredit Berdokumen Dalam Negeri)' ];
