            ...
            <?php 
                ...
                ?>  
                    ...
                    <?php  if($item['is_lock'] == 0){ ?>
                        <a class="btn btn-danger btn-xs" onclick="_confirm('Lock Surat Jalan?', '<?=site_url('managersj/unlock/'. $item['id'])?>')"><i class="fa fa-lock"></i> Lock Surat Jalan</a><br />
                      <?php }else{ ?>
                      <?php if($item['total_unlock'] <= 2): ?>
                        <a class="btn btn-warning btn-xs" onclick="_confirm('Unlock Surat Jalan?', '<?=site_url('managersj/unlock/'. $item['id'])?>')"><i class="fa fa-unlock"></i> Unlock Surat Jalan</a>
                      <?php endif; ?>
                    <?php }?>
