      ...
      <div class="x_content">
        ...
        <form id="form-quotation" method="post" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="text" id="no_so" readonly="true" name="Employee_so[no_so]" value="<?=$data['no_so']?>"  class="form-control col-md-7 col-xs-10">
            </div>
          </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select class="form-control select-qo" disabled="true">
                <option value=""> <?=$data['no_po']?> </option>
              </select>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="tanggal" value="<?=(isset($data['jadwal_selesai']) ? $data['jadwal_selesai'] : date('Y-m-d'))?>" name="Employee_so[jadwal_selesai]" disabled="true" class="form-control col-md-7 col-xs-12 tanggal">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="penerima_lapangan">Penerima Lapangan</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="tanggal" value="<?=(isset($data['penerima_lapangan']) ? $data['penerima_lapangan'] : '')?>"  disabled="true" name="Employee_so[penerima_lapangan]" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="no_telepon">No Telepon</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="tanggal" value="<?=(isset($data['no_telepon']) ? $data['no_telepon'] : '')?>"  required="required" name="Employee_so[no_telepon]" disabled="true" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div>
            <div class="x_panel">
          ...
          <div class="form-group">
            <div>
              ...
              <a class="btn btn-success btn-proccess btn-sm">Approve Sales Order <i class="fa fa-arrow-right"></i></a>
            </div>
          </div>
        </form>
      </div>
...
<script type="text/javascript">
  $(".btn-proccess").click(function(){
    ...
    _confirm('Approve Sales Order ini lewati semua proses approval dari AR dan Manager?', '<?=site_url('employeeso/submitapprove/'. $data['id'])?>')
