        ...
        <form id="form-quotation" method="post" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="<?=(isset($data['jadwal_mulai']) ? $data['jadwal_mulai'] : date('Y-m-d'));?>" id="tanggal_mulai" required="required" name="Employee_so[jadwal_mulai]" class="form-control col-md-7 col-xs-12 tanggal">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Jadwal Selesai</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="tanggal_selesai" value="<?=(isset($data['jadwal_selesai']) ? $data['jadwal_selesai'] : date('Y-m-d'))?>"  required="required" name="Employee_so[jadwal_selesai]" class="form-control col-md-7 col-xs-12 tanggal">
            </div>
          </div>
          <div>
            <div class="x_panel">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              ...
              <a class="btn btn-success btn-proccess">Submit Revisi</a>
            </div>
          </div>
