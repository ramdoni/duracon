        ...
        <form id="form-quotation" method="post" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              <a href="<?=site_url('arqo')?>" class="btn btn-warning"> <i class="fa fa-arrow-left"></i>  Cancel</a>
              <a class="btn btn-danger btn-reject"><i class="fa fa-close"></i> Reject</a>
              <a class="btn btn-success btn-proccess">Approved <i class="fa fa-check"></i> </a>
            </div>
          </div>
