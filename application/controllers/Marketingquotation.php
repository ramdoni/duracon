...
class Marketingquotation extends CI_Controller {
	...
	public function index()
	{
		...
		$params['page'] = 'marketingquotation/index';
		$params['data'] = $this->model->data_(0, 0, 0, ['quotation_order.marketing_id' => $this->session->userdata('employee_id')]);
	...
	public function proccess($id)
	{
		...
		if($this->input->post())
		{
			...
			redirect('marketingquotation/index','location');
		}
		
		$params['page'] = 'marketingquotation/proccess';
		$params['data'] = $model;
